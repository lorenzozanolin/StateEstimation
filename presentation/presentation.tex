...
\begin{table}[]
    ...
    Transformer, dropout = 0.3            & 20                                     & 16                                         & 0.389               & 0.4496             \\ \hline
    \end{tabular}
    \end{table}
As we can see, we obtained slightly better results using LSTMs; the runs were done mainly on CPU, thus the required time per epoch was always above 1-2 mins.\\\vspace{5mm}
Note: All the measurements were done using a M1 Pro 10 core.\\
We will now show the obtained graphs of the errors w.r.t. the number of epochs.\\\vspace{5mm}
Results with LSTM:
\begin{figure}[!htb]
    \begin{center}
